"""
ProductWithVariantsInfo aggregate value object combining product info with
variants. Used when users query for a product without specifying a variant.
"""
...
class ProductWithVariantsInfo(BaseModel):
    ...
    def get_price_display_range(self) -> str:
        ...
        min_formatted = format_rupiah(min_price)
        max_formatted = format_rupiah(max_price)
